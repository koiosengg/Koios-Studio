...
import PersonPhoto from "/PriyankaKP.jpg";
  ...
  return (
    <div className="virtual-card">
      <div className="virtual-card-bottom-bar mobile">
        ...
        <a
          href="https://www.linkedin.com/in/priyankakp"
          target="_blank"
        ...
        <div className="virtual-card-banner-container">
          <div className="virtual-card-banner-left">
            <div className="virtual-card-banner-left-text">
              ...
              <p>
                A creative and detail-driven Social Media Manager skilled in
                designing engaging content using Canva.
              </p>
            </div>
            <a
              href="https://www.linkedin.com/in/priyankakp"
      ...
      <div className="virtual-card-about">
        ...
        <div className="virtual-card-about-container">
          ...
          <p>
            Strong in organic social media growth strategies with a focus on
            consistent ideation, planning, and execution of content calendars.
            Experienced in researching trends, building brand presence, and
            creating meaningful post ideas that connect with the audience.
          </p>
        </div>
      ...
      <div className="virtual-card-reach">
        ...
        <div className="virtual-card-reach-container">
          <section>
            ...
            <a
              href="https://mail.google.com/mail/?view=cm&to=pri.yuktha@gmail.com"
              className="virtual-card-reach-set"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img src={EmailIcon} />
              <p>pri.yuktha@gmail.com</p>
            </a>
            <a
      ...
      <div className="virtual-card-find">
        ...
        <div className="virtual-card-find-container">
          ...
          <a
            href="https://www.facebook.com/share/15oqYUs1kw/"
            target="_blank"
            className="virtual-card-find-set"
          >
            <div className="virtual-card-find-icon">
          ...
          <a
            href="https://www.instagram.com/priyankaravigowda?igsh=MTU5ZDBmbzN5YjBkeg=="
            target="_blank"
            className="virtual-card-find-set"
          >
            <div className="virtual-card-find-icon">
