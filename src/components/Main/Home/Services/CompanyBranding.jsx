...
import Img1 from "../../assets/Home/Company Branding/Img1.webp";
import Img2 from "../../assets/Home/Company Branding/Img2.webp";
    ...
    <div className="s-product-list-set">
      ...
      <div className="s-product-list-set-container">
          ...
          <div className="s-slider" ref={sliderContentRef}>
            {slides.map((img, index) => (
              <img
                loading="lazy"
                src={img}
                alt={`Company Branding Showcase slide ${index + 1}`}
                key={index}
              />
            ))}
          </div>
        ...
        <p className="subpage-desc">
          We mastermind elite branding solutions, crafting logos, banners,
          letterheads, and business cards. Our meticulous approach ensures
          perfect alignment with your brand identity, leaving an indelible mark
          across industries.
        </p>

        <Link to="/company_branding" aria-label="Explore Company Branding Services">
