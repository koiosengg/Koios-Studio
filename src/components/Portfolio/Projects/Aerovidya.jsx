...
import Cover from "../assests/Projects/Aerovidya/Cover.png";
import HeadingDesign from "../assests/Home/Section Heading Design.png";
import Img1 from "../assests/Projects/Aerovidya/Image 1.png";
import Img21 from "../assests/Projects/Aerovidya/Image 2.1.png";
import Img22 from "../assests/Projects/Aerovidya/Image 2.2.png";
import Img3 from "../assests/Projects/Aerovidya/Image 3.png";
  ...
  return (
    <div className="portfolio portfolio-projects">
      ...
      <div className="portfolio-projects-cover">
        <img src={Cover} alt="Aerovidya Cover" />
      </div>
      ...
      <div className="portfolio-projects-gallery">
        <div className="portfolio-projects-gallery-container branding">
          <img src={Img1} alt="Aerovidya Project Image" />
          <section>
            <img src={Img21} alt="Aerovidya Project Image" />
            <img src={Img22} alt="Aerovidya Project Image" />
          </section>
          <img src={Img3} alt="Aerovidya Project Image" />
        </div>
      </div>
      <Projects />
      <Footer />
