...
function Porjects() {
  ...
  useEffect(() => {
    if (containerRef.current) {
      const sets = containerRef.current.querySelectorAll(
        ".portfolio-websites-porjects-set"
      );
  ...
  return (
    <div className="portfolio-websites-porjects">
      <div className="portfolio-websites-porjects-heading">
        <div className="portfolio-section-heading">
          <img src={HeadingDesign} className="portfolio-section-heading-img" />
          <h2>Projects</h2>
        </div>
        <div className="portfolio-websites-porjects-controls">
          <button
            className="portfolio-websites-porjects-control"
            onClick={handlePrev}
      ...
      <div className="portfolio-websites-porjects-container" ref={containerRef}>
        <div
          className="portfolio-websites-porjects-container-slide"
          style={{
        ...
        >
          <a href="#" className="portfolio-websites-porjects-set">
            ...
            <div className="portfolio-websites-porjects-set-info">
              <section>
                <h3>NE Structures</h3>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
